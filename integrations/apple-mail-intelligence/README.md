...
The installer builds and copies the native helper to:

```text
~/Library/Application Support/FJG Task Manager/Mail Intelligence/
```

and installs all three workflows under `~/Library/Services/`.
